...
For details about how to create content modules and assemblies, see the link:https://htmlpreview.github.io/?https://github.com/redhat-documentation/modular-docs/blob/master/modular-docs-manual/modular-docs-manual.html[Modular Documentation Reference Guide].
